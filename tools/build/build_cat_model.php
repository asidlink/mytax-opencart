...
// Admin model - удаляет дубли событий (nowdoc)
$adminModel = <<<'PHP'
<?php
...
// Catalog model - защита от повторного чека (nowdoc)
$catModel = <<<'PHP'
<?php
...
// Catalog controller - полный URL для QR (nowdoc)
$catCtrl = <<<'PHP'
<?php
