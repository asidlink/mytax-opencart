...
// Admin model - удаляет дубли событий + добавляет событие checkout/success
$adminModel = <<<'PHP'
<?php
...
class Mytax extends \Opencart\System\Engine\Model {
    public function install(): void {
        ...
        // СОЗДАНИЕ ЧЕКА СРАЗУ ПРИ ВОЗВРАТЕ НА САЙТ ПОСЛЕ ОПЛАТЫ!
...
// Catalog model - защита от повторного чека
$catModel = <<<'PHP'
<?php
...
// Catalog controller - с событием для страницы success (чек создаётся сразу при возврате)
$catCtrl = <<<'PHP'
<?php
...
class Mytax extends \Opencart\System\Engine\Controller {
    ...
    // СРАЗУ ПОСЛЕ ОПЛАТЫ, при возврате на страницу успеха!
