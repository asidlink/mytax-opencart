 ...
 * ТИП: module (а не payment!)
 * Пути OC4: extension/mytax/admin/controller/module/...
 */
$zip = new ZipArchive();
...
// ===== ADMIN: extension/mytax/admin/controller/module/mytax.php =====
$zip->addFromString(
    'extension/mytax/admin/controller/module/mytax.php',
    file_get_contents("$tM/admin/controller/module/mytax.php")
);
echo "  + extension/mytax/admin/controller/module/mytax.php\n";
...
echo "  + extension/mytax/admin/model/module/mytax.php\n";
...
echo "  + extension/mytax/admin/language/ru-ru/module/mytax.php\n";
...
echo "  + extension/mytax/admin/view/template/module/mytax.twig\n";

// ===== CATALOG: extension/mytax/catalog/... =====
// catalog/controller/module/mytax.php (обработчик событий)
$zip->addFromString(
...
$zip->addFromString(
    ...
    file_get_contents("$tM/../zip_final/catalog/model/checkout/mytax.php")
);
...
echo "  + extension/mytax/catalog/language/ru-ru/module/mytax.php\n";
