...
$zip = new ZipArchive();
@unlink('G:/DOWNLOAD/mytax_fixed.zip');
if ($zip->open('G:/DOWNLOAD/mytax_fixed.zip', ZipArchive::CREATE) !== true) die("FAIL");
...
echo "  + admin/model/module/mytax.php (удаляет дубли событий)\n";

// Admin language - из GPT
...
echo "  + catalog/controller/module/mytax.php (передает qr_link)\n";

// Catalog model - из GPT
...
echo "\n=== ГОТОВО: G:/DOWNLOAD/mytax_fixed.zip ===\n";
$z2 = new ZipArchive();
$z2->open('G:/DOWNLOAD/mytax_fixed.zip');
